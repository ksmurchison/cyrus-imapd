...
typedef struct jmap_property_set {
    ...
    const ptrarray_t wildcards;        // list of wildcard props, e.g. "foo*"
    const ptrarray_t always_get;       // list of JMAP_PROP_ALWAYS_GET props
    const ptrarray_t mandatory;        // list of JMAP_PROP_MANDATORY props
} jmap_property_set_t;
